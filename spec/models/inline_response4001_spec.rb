...
# Unit tests for ConvictionalSeller::InlineResponse4001
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse4001 do
  let(:instance) { ConvictionalSeller::InlineResponse4001.new }

  describe 'test an instance of InlineResponse4001' do
    it 'should create an instance of InlineResponse4001' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse4001)
    end
  end
