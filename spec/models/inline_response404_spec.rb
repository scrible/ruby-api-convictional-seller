...
# Unit tests for ConvictionalSeller::InlineResponse404
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse404 do
  let(:instance) { ConvictionalSeller::InlineResponse404.new }

  describe 'test an instance of InlineResponse404' do
    it 'should create an instance of InlineResponse404' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse404)
    end
  end
