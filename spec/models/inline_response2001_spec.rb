...
# Unit tests for ConvictionalSeller::InlineResponse2001
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse2001 do
  let(:instance) { ConvictionalSeller::InlineResponse2001.new }

  describe 'test an instance of InlineResponse2001' do
    it 'should create an instance of InlineResponse2001' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse2001)
    end
  end
