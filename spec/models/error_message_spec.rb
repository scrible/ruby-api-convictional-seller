...
# Unit tests for ConvictionalSeller::ErrorMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::ErrorMessage do
  let(:instance) { ConvictionalSeller::ErrorMessage.new }

  describe 'test an instance of ErrorMessage' do
    it 'should create an instance of ErrorMessage' do
      expect(instance).to be_instance_of(ConvictionalSeller::ErrorMessage)
    end
  end
