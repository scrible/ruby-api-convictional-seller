...
# Unit tests for ConvictionalSeller::InlineResponse2002
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse2002 do
  let(:instance) { ConvictionalSeller::InlineResponse2002.new }

  describe 'test an instance of InlineResponse2002' do
    it 'should create an instance of InlineResponse2002' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse2002)
    end
  end
