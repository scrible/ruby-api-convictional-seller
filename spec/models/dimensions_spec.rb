...
# Unit tests for ConvictionalSeller::Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::Dimensions do
  let(:instance) { ConvictionalSeller::Dimensions.new }

  describe 'test an instance of Dimensions' do
    it 'should create an instance of Dimensions' do
      expect(instance).to be_instance_of(ConvictionalSeller::Dimensions)
    end
  end
