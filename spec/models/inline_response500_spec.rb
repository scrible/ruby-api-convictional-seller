...
# Unit tests for ConvictionalSeller::InlineResponse500
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse500 do
  let(:instance) { ConvictionalSeller::InlineResponse500.new }

  describe 'test an instance of InlineResponse500' do
    it 'should create an instance of InlineResponse500' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse500)
    end
  end
