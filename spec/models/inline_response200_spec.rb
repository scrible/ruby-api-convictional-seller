...
# Unit tests for ConvictionalSeller::InlineResponse200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalSeller::InlineResponse200 do
  let(:instance) { ConvictionalSeller::InlineResponse200.new }

  describe 'test an instance of InlineResponse200' do
    it 'should create an instance of InlineResponse200' do
      expect(instance).to be_instance_of(ConvictionalSeller::InlineResponse200)
    end
  end
